...
$(document).ready(function () { $("#IDPROSPECTO").on("change", 
 ...
 $(document).ready(function () { $("#IDESTATUS_tblprospecto").on("change", 
 function (event) { 
 // var type = event.args.type; // keyboard, mouse or null depending on how the value was changed. 
   // var value = $("#IDESTATUS_tblprospecto").val(); 
 });}); 
 ...
 $(document).ready(function () { $("#CELULAR").on("change", 
 function (event) { 
 // var type = event.args.type; // keyboard, mouse or null depending on how the value was changed. 
   // var value = $("#CELULAR").val(); 
 });}); 

 $(document).ready(function () { $("#DOMICILIO").on("change", 
 function (event) { 
 // var type = event.args.type; // keyboard, mouse or null depending on how the value was changed. 
   // var value = $("#DOMICILIO").val(); 
 });}); 

 $(document).ready(function () { $("#COLONIA").on("change", 
 function (event) { 
 // var type = event.args.type; // keyboard, mouse or null depending on how the value was changed. 
   // var value = $("#COLONIA").val(); 
 });}); 

 $(document).ready(function () { $("#CODIGO_POSTAL").on("change", 
 function (event) { 
 // var type = event.args.type; // keyboard, mouse or null depending on how the value was changed. 
   // var value = $("#CODIGO_POSTAL").val(); 
 });}); 

 $(document).ready(function () { $("#CIUDAD").on("change", 
 function (event) { 
 // var type = event.args.type; // keyboard, mouse or null depending on how the value was changed. 
   // var value = $("#CIUDAD").val(); 
 });}); 

 $(document).ready(function () { $("#ESTADO").on("change", 
 function (event) { 
 // var type = event.args.type; // keyboard, mouse or null depending on how the value was changed. 
   // var value = $("#ESTADO").val(); 
 });}); 

 $(document).ready(function () { $("#PAIS").on("change", 
 function (event) { 
 // var type = event.args.type; // keyboard, mouse or null depending on how the value was changed. 
   // var value = $("#PAIS").val(); 
 });}); 

 $(document).ready(function () { $("#EMPRESA").on("change", 
 function (event) { 
 // var type = event.args.type; // keyboard, mouse or null depending on how the value was changed. 
   // var value = $("#EMPRESA").val(); 
 });}); 

 $(document).ready(function () { $("#PUESTO").on("change", 
 function (event) { 
 // var type = event.args.type; // keyboard, mouse or null depending on how the value was changed. 
   // var value = $("#PUESTO").val(); 
 });}); 

 $(document).ready(function () { $("#IDORIGENPROSPECTO").on("change", 
 function (event) { 
 // var type = event.args.type; // keyboard, mouse or null depending on how the value was changed. 
   // var value = $("#IDORIGENPROSPECTO").val(); 
 });}); 

 $(document).ready(function () { $("#NECESIDADES").on("change", 
 function (event) { 
 // var type = event.args.type; // keyboard, mouse or null depending on how the value was changed. 
   // var value = $("#NECESIDADES").val(); 
 });}); 
 ...
 $(document).ready(function () { $("#RFC").on("change", 
 function (event) { 
 // var type = event.args.type; // keyboard, mouse or null depending on how the value was changed. 
   // var value = $("#RFC").val(); 
 });}); 
