<script>
$(document).ready(function () { $("#IDDIAGRAMA").on("change", 
 function (event) { 
 // var type = event.args.type; // keyboard, mouse or null depending on how the value was changed. 
   // var value = $("#IDDIAGRAMA").val(); 
 });}); 

 $(document).ready(function () { $("#NOMBRE_DIAGRAMA").on("change", 
 function (event) { 
 // var type = event.args.type; // keyboard, mouse or null depending on how the value was changed. 
   // var value = $("#NOMBRE_DIAGRAMA").val(); 
 });}); 

 $(document).ready(function () { $("#URL_DIAGRAMA").on("change", 
 function (event) { 
 // var type = event.args.type; // keyboard, mouse or null depending on how the value was changed. 
   // var value = $("#URL_DIAGRAMA").val(); 
 });}); 
 ...
 $(document).ready(function () { $("#IDDEPARTAMENTO").on("change", 
 function (event) { 
 // var type = event.args.type; // keyboard, mouse or null depending on how the value was changed. 
   // var value = $("#IDDEPARTAMENTO").val(); 
 });}); 

 $(document).ready(function () { $("#IDCATEGORIAPROCESO").on("change", 
 function (event) { 
 // var type = event.args.type; // keyboard, mouse or null depending on how the value was changed. 
   // var value = $("#IDCATEGORIAPROCESO").val(); 
 });}); 
