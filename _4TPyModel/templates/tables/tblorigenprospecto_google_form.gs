...
var db = 'veterinario';
function formbuild() { 
var form = FormApp.create("Orígenes de Prospecto"); 
var conexion=conectar_mysql(); //realizo conexion con mysql



var guardar = SpreadsheetApp.create('Orígenes de Prospecto');
...
item.setTitle("Origen Prospecto");
...
var sentencia="insert into tblorigenprospecto(ORIGENPROSPECTO,OBSERVACIONES) values ('"  + itemResponses[0].getResponse() + "','"  + itemResponses[1].getResponse() + "')";
