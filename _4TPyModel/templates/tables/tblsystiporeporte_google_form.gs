...
var db = 'veterinario';
function formbuild() { 
var form = FormApp.create("Tipos de Reporte"); 
var conexion=conectar_mysql(); //realizo conexion con mysql



var guardar = SpreadsheetApp.create('Tipos de Reporte');
...
var sentencia="insert into tblsystiporeporte(TIPOREPORTE,OBSERVACIONES) values ('"  + itemResponses[0].getResponse() + "','"  + itemResponses[1].getResponse() + "')";
