...
var db = 'veterinario';
function formbuild() { 
var form = FormApp.create("Configuraciones de Sistema"); 
var conexion=conectar_mysql(); //realizo conexion con mysql



var guardar = SpreadsheetApp.create('Configuraciones de Sistema');
...
var sentencia="insert into tblsysconfig(CONCEPT,VALUE,OBSERVACIONES) values ('"  + itemResponses[0].getResponse() + "','"  + itemResponses[1].getResponse() + "','"  + itemResponses[2].getResponse() + "')";
