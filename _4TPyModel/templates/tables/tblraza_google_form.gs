...
var db = 'veterinario';
function formbuild() { 
var form = FormApp.create("Raza"); 
var conexion=conectar_mysql(); //realizo conexion con mysql



var guardar = SpreadsheetApp.create('Raza');
...
var sentencia="insert into tblraza(RAZA,OBSERVACIONES) values ('"  + itemResponses[0].getResponse() + "','"  + itemResponses[1].getResponse() + "')";
