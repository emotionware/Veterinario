...
var db = 'veterinario';
function formbuild() { 
var form = FormApp.create("Tipos de Seguimiento"); 
var conexion=conectar_mysql(); //realizo conexion con mysql



var guardar = SpreadsheetApp.create('Tipos de Seguimiento');
...
item.setTitle("Tipo Seguimiento");
...
var sentencia="insert into tbltiposeguimiento(TIPOSEGUIMIENTO,OBSERVACIONES) values ('"  + itemResponses[0].getResponse() + "','"  + itemResponses[1].getResponse() + "')";
