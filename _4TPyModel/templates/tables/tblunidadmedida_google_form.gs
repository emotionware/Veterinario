...
var db = 'veterinario';
function formbuild() { 
var form = FormApp.create("Unidad de Medida"); 
var conexion=conectar_mysql(); //realizo conexion con mysql



var guardar = SpreadsheetApp.create('Unidad de Medida');
...
var sentencia="insert into tblunidadmedida(UNIDADMEDIDA,DESCRIPCION,OBSERVACIONES) values ('"  + itemResponses[0].getResponse() + "','"  + itemResponses[1].getResponse() + "','"  + itemResponses[2].getResponse() + "')";
