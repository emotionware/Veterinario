...
var db = 'veterinario';
function formbuild() { 
var form = FormApp.create("Análisis de Caducidad"); 
var conexion=conectar_mysql(); //realizo conexion con mysql



var guardar = SpreadsheetApp.create('Análisis de Caducidad');
...
var sentencia="insert into view_analisis_caducidad(CODIGO,NOMBRE_ARTICULO,LOTE,CANTIDAD,CADUCIDAD,DIAS_RESTANTES,CATEGORIA1,CATEGORIA2) values ('"  + itemResponses[0].getResponse() + "','"  + itemResponses[1].getResponse() + "','"  + itemResponses[2].getResponse() + "','"  + itemResponses[3].getResponse() + "','"  + itemResponses[4].getResponse() + "','"  + itemResponses[5].getResponse() + "','"  + itemResponses[6].getResponse() + "','"  + itemResponses[7].getResponse() + "')";
