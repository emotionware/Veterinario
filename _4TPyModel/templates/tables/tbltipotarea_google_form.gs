...
var db = 'veterinario';
function formbuild() { 
var form = FormApp.create("Tipos de Tarea"); 
var conexion=conectar_mysql(); //realizo conexion con mysql



var guardar = SpreadsheetApp.create('Tipos de Tarea');
...
var sentencia="insert into tbltipotarea(TIPOTAREA,OBSERVACIONES) values ('"  + itemResponses[0].getResponse() + "','"  + itemResponses[1].getResponse() + "')";
