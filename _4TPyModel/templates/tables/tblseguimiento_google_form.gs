...
var db = 'veterinario';
function formbuild() { 
var form = FormApp.create("Seguimientos"); 
var conexion=conectar_mysql(); //realizo conexion con mysql



var guardar = SpreadsheetApp.create('Seguimientos');
...
item.setTitle("Registro Del Seguimiento");
...
var sentencia="insert into tblseguimiento(FECHA,HORA,REGISTRO_SEGUIMIENTO,OBSERVACIONES) values ('"  + itemResponses[0].getResponse() + "','"  + itemResponses[1].getResponse() + "','"  + itemResponses[2].getResponse() + "','"  + itemResponses[3].getResponse() + "')";
