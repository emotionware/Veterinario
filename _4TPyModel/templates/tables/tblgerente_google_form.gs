...
var db = 'veterinario';
function formbuild() { 
var form = FormApp.create("Gerentes"); 
var conexion=conectar_mysql(); //realizo conexion con mysql



var guardar = SpreadsheetApp.create('Gerentes');
...
var sentencia="insert into tblgerente(NOMBREGERENTE,EMAIL,TELEFONO,OBSERVACIONES) values ('"  + itemResponses[0].getResponse() + "','"  + itemResponses[1].getResponse() + "','"  + itemResponses[2].getResponse() + "','"  + itemResponses[3].getResponse() + "')";
