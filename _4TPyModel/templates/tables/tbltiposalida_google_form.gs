...
var db = 'veterinario';
function formbuild() { 
var form = FormApp.create("Tipo Salida"); 
var conexion=conectar_mysql(); //realizo conexion con mysql



var guardar = SpreadsheetApp.create('Tipo Salida');
...
var sentencia="insert into tbltiposalida(TIPOSALIDA,OBSERVACIONES) values ('"  + itemResponses[0].getResponse() + "','"  + itemResponses[1].getResponse() + "')";
