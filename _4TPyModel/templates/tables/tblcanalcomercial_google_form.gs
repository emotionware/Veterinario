...
var db = 'veterinario';
function formbuild() { 
var form = FormApp.create("Canales Comerciales"); 
var conexion=conectar_mysql(); //realizo conexion con mysql



var guardar = SpreadsheetApp.create('Canales Comerciales');
...
var sentencia="insert into tblcanalcomercial(CANALCOMERCIAL,OBSERVACIONES) values ('"  + itemResponses[0].getResponse() + "','"  + itemResponses[1].getResponse() + "')";
