...
var db = 'veterinario';
function formbuild() { 
var form = FormApp.create("Supervisores"); 
var conexion=conectar_mysql(); //realizo conexion con mysql



var guardar = SpreadsheetApp.create('Supervisores');
...
var sentencia="insert into tblsupervisor(NOMBRE,EMAIL,TELEFONO,OBSERVACIONES) values ('"  + itemResponses[0].getResponse() + "','"  + itemResponses[1].getResponse() + "','"  + itemResponses[2].getResponse() + "','"  + itemResponses[3].getResponse() + "')";
