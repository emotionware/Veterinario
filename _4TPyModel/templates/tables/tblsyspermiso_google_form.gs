...
var db = 'veterinario';
function formbuild() { 
var form = FormApp.create("Permisos"); 
var conexion=conectar_mysql(); //realizo conexion con mysql



var guardar = SpreadsheetApp.create('Permisos');
...
var sentencia="insert into tblsyspermiso(TABLA,OBSERVACIONES) values ('"  + itemResponses[0].getResponse() + "','"  + itemResponses[1].getResponse() + "')";
