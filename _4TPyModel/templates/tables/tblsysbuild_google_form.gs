...
var db = 'veterinario';
function formbuild() { 
var form = FormApp.create("Tablas en el Flujo de Construcción"); 
var conexion=conectar_mysql(); //realizo conexion con mysql



var guardar = SpreadsheetApp.create('Tablas en el Flujo de Construcción');
...
var sentencia="insert into tblsysbuild(TABLENAME,OBSERVACIONES) values ('"  + itemResponses[0].getResponse() + "','"  + itemResponses[1].getResponse() + "')";
