...
var db = 'veterinario';
function formbuild() { 
var form = FormApp.create("Almacenes"); 
var conexion=conectar_mysql(); //realizo conexion con mysql



var guardar = SpreadsheetApp.create('Almacenes');
...
var sentencia="insert into tblalmacen(NOMBRE_ALMACEN,OBSERVACIONES) values ('"  + itemResponses[0].getResponse() + "','"  + itemResponses[1].getResponse() + "')";
