...
var db = 'veterinario';
function formbuild() { 
var form = FormApp.create("Especie"); 
var conexion=conectar_mysql(); //realizo conexion con mysql



var guardar = SpreadsheetApp.create('Especie');
...
var sentencia="insert into tblespecie(ESPECIE,OBSERVACIONES) values ('"  + itemResponses[0].getResponse() + "','"  + itemResponses[1].getResponse() + "')";
