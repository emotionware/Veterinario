...
var sentencia="insert into tblproveedor(EMPRESA,NOMBRE,APELLIDO,EMAIL,CELULAR,PUESTO,DOMICILIO,COLONIA,CODIGO_POSTAL,CIUDAD,ESTADO,PAIS,OBSERVACIONES) values ('"  + itemResponses[0].getResponse() + "','"  + itemResponses[1].getResponse() + "','"  + itemResponses[2].getResponse() + "','"  + itemResponses[3].getResponse() + "','"  + itemResponses[4].getResponse() + "','"  + itemResponses[5].getResponse() + "','"  + itemResponses[6].getResponse() + "','"  + itemResponses[7].getResponse() + "','"  + itemResponses[8].getResponse() + "','"  + itemResponses[9].getResponse() + "','"  + itemResponses[10].getResponse() + "','"  + itemResponses[11].getResponse() + "','"  + itemResponses[12].getResponse() + "')";
