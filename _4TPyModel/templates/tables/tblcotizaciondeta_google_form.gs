...
var sentencia="insert into tblcotizaciondeta(LOTE,OBSERVACIONES,PRECIO_ARTICULO,CANTIDAD,PORC_DESCUENTO,IMPORTE_DESCUENTO,PRECIO_UNITARIO,SUBTOTAL,PORC_IVA,IMPORTE_IVA,TOTAL) values ('"  + itemResponses[0].getResponse() + "','"  + itemResponses[1].getResponse() + "','"  + itemResponses[2].getResponse() + "','"  + itemResponses[3].getResponse() + "','"  + itemResponses[4].getResponse() + "','"  + itemResponses[5].getResponse() + "','"  + itemResponses[6].getResponse() + "','"  + itemResponses[7].getResponse() + "','"  + itemResponses[8].getResponse() + "','"  + itemResponses[9].getResponse() + "','"  + itemResponses[10].getResponse() + "')";
