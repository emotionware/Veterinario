...
var db = 'veterinario';
function formbuild() { 
var form = FormApp.create("Categoría 1"); 
var conexion=conectar_mysql(); //realizo conexion con mysql



var guardar = SpreadsheetApp.create('Categoría 1');
...
var sentencia="insert into tblcategoria1(CATEGORIA1,OBSERVACIONES) values ('"  + itemResponses[0].getResponse() + "','"  + itemResponses[1].getResponse() + "')";
