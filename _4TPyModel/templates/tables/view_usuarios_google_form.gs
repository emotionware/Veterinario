...
var db = 'veterinario';
function formbuild() { 
var form = FormApp.create("Usuarios"); 
var conexion=conectar_mysql(); //realizo conexion con mysql



var guardar = SpreadsheetApp.create('Usuarios');
...
var sentencia="insert into view_usuarios(IDSYSUSER,USERNAME,NAME,EMAIL,USER_LINK) values ('"  + itemResponses[0].getResponse() + "','"  + itemResponses[1].getResponse() + "','"  + itemResponses[2].getResponse() + "','"  + itemResponses[3].getResponse() + "','"  + itemResponses[4].getResponse() + "')";
