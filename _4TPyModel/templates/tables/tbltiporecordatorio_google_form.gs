...
var db = 'veterinario';
function formbuild() { 
var form = FormApp.create("Tipo de Recordatorio"); 
var conexion=conectar_mysql(); //realizo conexion con mysql



var guardar = SpreadsheetApp.create('Tipo de Recordatorio');
...
var sentencia="insert into tbltiporecordatorio(TIPO,OBSERVACIONES) values ('"  + itemResponses[0].getResponse() + "','"  + itemResponses[1].getResponse() + "')";
