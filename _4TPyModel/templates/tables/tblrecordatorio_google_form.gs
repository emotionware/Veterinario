...
var db = 'veterinario';
function formbuild() { 
var form = FormApp.create("Recordatorios"); 
var conexion=conectar_mysql(); //realizo conexion con mysql



var guardar = SpreadsheetApp.create('Recordatorios');
...
var sentencia="insert into tblrecordatorio(FECHA,HORA,DESCRIPCION,OBSERVACIONES) values ('"  + itemResponses[0].getResponse() + "','"  + itemResponses[1].getResponse() + "','"  + itemResponses[2].getResponse() + "','"  + itemResponses[3].getResponse() + "')";
