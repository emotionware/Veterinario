...
var db = 'veterinario';
function formbuild() { 
var form = FormApp.create("Tipos de Usuario"); 
var conexion=conectar_mysql(); //realizo conexion con mysql



var guardar = SpreadsheetApp.create('Tipos de Usuario');
...
var sentencia="insert into tbltipouser(TIPO,OBSERVACIONES) values ('"  + itemResponses[0].getResponse() + "','"  + itemResponses[1].getResponse() + "')";
