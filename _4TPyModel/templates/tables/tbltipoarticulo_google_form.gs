...
var db = 'veterinario';
function formbuild() { 
var form = FormApp.create("Tipos de Artículos"); 
var conexion=conectar_mysql(); //realizo conexion con mysql



var guardar = SpreadsheetApp.create('Tipos de Artículos');
...
var sentencia="insert into tbltipoarticulo(TIPOARTICULO,OBSERVACIONES) values ('"  + itemResponses[0].getResponse() + "','"  + itemResponses[1].getResponse() + "')";
