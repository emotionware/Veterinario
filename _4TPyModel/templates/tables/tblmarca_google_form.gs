...
var db = 'veterinario';
function formbuild() { 
var form = FormApp.create("Marcas"); 
var conexion=conectar_mysql(); //realizo conexion con mysql



var guardar = SpreadsheetApp.create('Marcas');
...
var sentencia="insert into tblmarca(MARCA,AUXILIAR1_char,OBSERVACIONES) values ('"  + itemResponses[0].getResponse() + "','"  + itemResponses[1].getResponse() + "','"  + itemResponses[2].getResponse() + "')";
