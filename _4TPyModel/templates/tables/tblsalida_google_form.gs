...
var db = 'veterinario';
function formbuild() { 
var form = FormApp.create("Salida"); 
var conexion=conectar_mysql(); //realizo conexion con mysql



var guardar = SpreadsheetApp.create('Salida');
...
var sentencia="insert into tblsalida(FECHA,LOTE,CANTIDAD,OBSERVACIONES) values ('"  + itemResponses[0].getResponse() + "','"  + itemResponses[1].getResponse() + "','"  + itemResponses[2].getResponse() + "','"  + itemResponses[3].getResponse() + "')";
