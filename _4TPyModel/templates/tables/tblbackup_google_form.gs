...
var db = 'veterinario';
function formbuild() { 
var form = FormApp.create("Backups"); 
var conexion=conectar_mysql(); //realizo conexion con mysql



var guardar = SpreadsheetApp.create('Backups');
...
var sentencia="insert into tblbackup(FECHABACKUP,OBSERVACIONES) values ('"  + itemResponses[0].getResponse() + "','"  + itemResponses[1].getResponse() + "')";
