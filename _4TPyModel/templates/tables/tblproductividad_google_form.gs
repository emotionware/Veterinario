...
var db = 'veterinario';
function formbuild() { 
var form = FormApp.create("Productividad"); 
var conexion=conectar_mysql(); //realizo conexion con mysql



var guardar = SpreadsheetApp.create('Productividad');
...
var sentencia="insert into tblproductividad(USERNAME,ACCION,TABLA,FECHA,HORA,OBSERVACIONES) values ('"  + itemResponses[0].getResponse() + "','"  + itemResponses[1].getResponse() + "','"  + itemResponses[2].getResponse() + "','"  + itemResponses[3].getResponse() + "','"  + itemResponses[4].getResponse() + "','"  + itemResponses[5].getResponse() + "')";
