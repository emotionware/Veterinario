...
var db = 'veterinario';
function formbuild() { 
var form = FormApp.create("Relaciones Master-Detalle"); 
var conexion=conectar_mysql(); //realizo conexion con mysql



var guardar = SpreadsheetApp.create('Relaciones Master-Detalle');
...
var sentencia="insert into tblsysmasterdetail(MASTER,DETAIL,OBSERVACIONES) values ('"  + itemResponses[0].getResponse() + "','"  + itemResponses[1].getResponse() + "','"  + itemResponses[2].getResponse() + "')";
