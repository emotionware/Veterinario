...
var db = 'veterinario';
function formbuild() { 
var form = FormApp.create("Existencia"); 
var conexion=conectar_mysql(); //realizo conexion con mysql



var guardar = SpreadsheetApp.create('Existencia');
...
var sentencia="insert into tblexistencia(LOTE,CADUCIDAD,EXISTENCIA,OBSERVACIONES) values ('"  + itemResponses[0].getResponse() + "','"  + itemResponses[1].getResponse() + "','"  + itemResponses[2].getResponse() + "','"  + itemResponses[3].getResponse() + "')";
